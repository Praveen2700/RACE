...
function validateSignupForm() {
  ...
  if (!emailRegex.test(signupEmail)) {
    Toastify({
      text: "Invalid email address. Please use the example@reva.edu.in format.",
      duration: 3000,
      backgroundColor: "rgba(255, 0, 0, 0.7)", // Adjust transparency here
      style: {
        "width": "300px",
        "margin-top": "50px"
      }
  ...
  if (!passwordRegex.test(signupPassword)) {
    Toastify({
      text: "Password must be at least 8 characters long, contain at least one special character, one number, and include a capital letter.",
      duration: 3000,
      backgroundColor: "rgba(255, 0, 0, 0.7)", // Adjust transparency here
      style: {
        "width": "300px",
