...
//menu
function expandMenu() {
    //document.getElementById("menu").style.width = "15%"; // Adjust the width of the menu as needed
    document.getElementById("calendarContainer").style.transition = "margin-left 0.3s"; // Add transition for smooth movement
    document.getElementById("calendarContainer").style.width = "calc(100% - 300px)"; // Adjust the width of the calendar container
}

function collapseMenu() {
    //document.getElementById("menu").style.width = "50px"; // Adjust the width of the menu as needed
    document.getElementById("calendarContainer").style.width = "1200px"; // Adjust the width of the calendar container
}
...
function downloadReport() {
  ...
  if (startDate === '' || endDate === '') {
    showToastMessage('error','Please select both From Date and To Date before downloading the report.');
  }
